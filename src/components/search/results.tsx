    ...
    return (
      <SafeAreaView style={style('w-full')}>
        <View style={style('w-full max-w-[90vw] flex flex-row')}>
          <Text
            style={style(
              'text-2xl md:text-2.5xl  px-5 mb-4 font-medium mt-4 text-left leading-7 font-bold'
            )}>
            Résultats pour&nbsp; &quot;
          </Text>
          ...
          <Text
            style={style(
              'text-2xl md:text-2.5xl font-medium mt-4 text-left leading-7 font-bold text-secondary-300 font-italic'
            )}>
            {search}
          </Text>
          <Text
            style={style('text-2xl md:text-2.5xl font-medium mt-4 text-left leading-7 italic ')}>
            &quot;
          </Text>
          <Text
            style={style(
              'text-2xl md:text-2.5xl font-medium mt-4 text-left leading-7 text-secondary-300 '
            )}>
            ({shouldData?.length})
          </Text>
        </View>
        <View style={style('w-full flex flex-col justify-center')}>
    ...
    return (
      <SafeAreaView style={style('w-95 mx-auto')}>
        <View style={style('w-full max-w-[90%] flex flex-row mb-2')}>
          <Text
            style={style('text-2xl md:text-2.5xl font-medium mt-4 text-left leading-7 font-bold')}>
            Résultats pour&nbsp; &quot;
          </Text>
